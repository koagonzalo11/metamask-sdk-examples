      ...
      <Container w="5xl" h="100vh">
        <Flex align="center" justify="space-between" py={10}>
          ...
          <Flex gap={4} align="center">
            {isConnected && (
              <NetworkDropdown network={currentNetwork} onNetworkChange={handleNetworkChange} />
            )}
            ...
            <Flex direction="column" gap={8}>
              ...
              >
                <Flex gap={4} wrap="wrap">
                  <Button onClick={handleSignMessage} colorScheme="gray" size="lg">
                    Sign Message
                  </Button>
                  <Button onClick={handleFetchBlockNumber} colorScheme="gray" size="lg">
                    Fetch Latest Block
                  </Button>
                </Flex>
              </CardContainer>
              ...
              >
                <Flex direction="column" gap={3}>
                  <Link href="https://docs.metamask.io/sdk/" target="_blank" color="blue.400" gap={2}>
                    Documentation <ExternalLink size={16} />
                  </Link>
                  <Link href="https://github.com/MetaMask/metamask-sdk" target="_blank" color="blue.400" gap={2}>
                    GitHub Repository <ExternalLink size={16} />
                  </Link>
                  <Link href="https://docs.metamask.io/sdk/reference/" target="_blank" color="blue.400" gap={2}>
